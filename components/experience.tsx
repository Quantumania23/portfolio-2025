              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="text-center">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-[#b4bcd0]">September 2022 - Present</span>
                  </div>
                  <div
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="flex items-center space-x-6 mb-6 md:mb-0">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-4 text-[#b4bcd0]">
                      <div className="flex items-center space-x-1">
                        <Building2 className="w-4 h-4" />
                        <span>Dansted Technologies</span>
                      </div>
                      <div className="flex items-center space-x-1">
                        <MapPin className="w-4 h-4" />
                        <span>Kenya</span>
                ...
                <div className="text-center">
                  <div className="flex items-center space-x-2 mb-2">
                    <Calendar className="w-5 h-5 text-[#00d4ff]" />
                    <span className="text-[#b4bcd0]">July 2023 - January 2024</span>
                  </div>
                  <div
                    className="text-2xl font-bold text-transparent"
                    style={{
