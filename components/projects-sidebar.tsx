...
const projects: Project[] = [
{
...
},
  {
    ...
    githubUrl: "https://github.com/Quantumania23/ShadowCoach-Boxer",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/Quantumania23/katiba360",
  ...
  },
  {
    ...
    tagline: "Podcastr is a revolutionary Software-as-a-Service platform that transforms the way podcasts are created.",
    ...
    technologies: ["Node.js", "ReactJs", "MongoDB", "TypeScript", "Framer"],
    category: "API",
    difficulty: "Intermediate",
    status: "Creation",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/Quantumania23/Teksade-The-Tech-Community-HQ",
...

  {
    ...
    githubUrl: "https://github.com/Quantumania23/AWS-Serverless-API",
    liveUrl: "https://github.com/Quantumania23/AWS-Serverless-API",
  ...
  },
  {
  ...
  },
   {
    ...
    tagline: "A NextJs banking platform",
    description: "Horizon is a comprehensive online banking platform that offers users a centralized finance management dashboard. It allows users to connect multiple bank accounts, monitor real-time transactions, and seamlessly transfer money to other users.",
    longDescription:
      "Built with Next.js 14 Appwrite, Dwolla and Plaid, Horizon ensures a smooth and secure banking experience, tailored to meet the needs of modern consumers..",
    technologies: ["NextJs", "Dwolla", "Plaid", "Appwrite", "Bootstrap"],
    category: "Web App",
    difficulty: "Intermediate",
    status: "Creation",
  ...
  
   {
    ...
    tagline: "Google Docs clone application with real-time document editing",
    description: "LiveDoc is a powerful collaborative app that elevates the capabilities of real-time document editing.",
    longDescription:
